...
<div id="main_container">
    ...
    <div class="main_content">
		...
		<div class="center_content">  
			...
			<div  class="right_content">
                ...
                $table = $_GET['table'];
               	...
               	if($ids != NULL && $table != NULL)
               	{
	                ...
	                $res = $pdo -> getRow($sql);
            ?>
            	<form action="doAction.php?table=YS_about&act=mod&ids=<?php echo $ids ?>" method="POST" enctype="multipart/form-data">
			...
			?>
				...
				<form action="doAction.php?table=YS_about" method="POST" enctype="multipart/form-data">
            ...
            <table width="100%" border="1" style="text-align:center">
                ...
                $sql  = "SELECT * FROM `YS_about` ORDER BY  id DESC LIMIT {$offset},{$pageSize}";
                $rows = $pdo->getAll($sql);
                ...
                ?>
                    ...
                    <tr>
                        <td><a href="../YS_about.php?id=<?php echo $id ;?>" target="_blank"><?php echo $title; ?></a></td>
                        <td><?php echo $author; ?></td>
                        <td><?php echo $times; ?></td>
                        <td><a href="#" onclick="mod(<?php echo $id; ?>,'YS_about')">修改</a></td>
                        <td><a href="#" onclick="del(<?php echo $id; ?>,'YS_about')">删除</a></td>
                    </tr>
   ...
   <?php  require_once 'include/footer.php' ; ?> 
    ...
    {
        window.location.href="YS_about.php?id="+ids+"&table="+table;
    }
    </script>
