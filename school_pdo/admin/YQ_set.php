		...
		<div class="center_content">  
			...
			<div class="left_content">	
				...
				<div class="sidebarmenu">
					<a class="menuitem" href="YQ_about.php">园区简介</a>
					<a class="menuitem" href="YQ_set.php">机构设置</a>	
				</div>
			...
			?>
				...
				<form action="doAction.php?table=YQ_set" method="POST" enctype="multipart/form-data">
                <h2>请填写机构设置内容：</h2><br /><br />
                <p>
            ...
            <table width="100%" border="1" style="text-align:center">
                ...
                ?>
                    <tr>
                        <td><a href="../YQ_set.php" target="_blank">机构设置</a></td>
