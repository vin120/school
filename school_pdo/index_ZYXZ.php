...
<div id="templatemo_wrapper">
    ...
    <p>你现在的位置是:<a href="index.php">首页</a> > <a href="index_ZYXZ.php">资源下载</a></p>
    ...
    <?php 
            ...
            if(!empty($id))
            {
                $sql = "SELECT * FROM  `index_ZYXZ` WHERE  id = $id";
                $row = $pdo->getRow($sql);
                $title = $row['title'];
                $author = $row['author'];
                $times = $row['times'];
    ...
    ?>
            ...
            <div style="padding-bottom: 6px; padding-top: 6px; padding-left: 6px; padding-right: 6px"><fieldset><legend><?php echo $title ;?></legend>
                <table cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td><a title="<?php echo $title ;?>" target="_blank" href="<?php echo $url ;?>"><?php echo $title ;?></a>&nbsp;(<?php echo $size ;?>)</td>
                        </tr>
                    </tbody>
                </table>
                </fieldset>
    ...
    <?php
            ...
            {   
                ...
                $sql  = "SELECT * FROM `index_ZYXZ` ORDER BY  id DESC LIMIT {$offset},{$pageSize}";
                $rows = $pdo->getAll($sql);
                ...
                foreach ($rows as $row ) 
                {
                    ...
                    $time = explode(" ",$times); 
            ?>
                <h4 align="left" ><a href = "index_ZYXZ.php?id=<?php echo $id?>"><?php echo $title ; ?></a><div style="float:right"><?php echo $time[0];?></div></h4>
