...
<div id="templatemo_wrapper">
    ...
    <p>你现在的位置是:<a href="index.php">首页</a> > <a href="CY_job.php">入驻团队招聘</a></p>
    ...
    <?php 
            ...
            if(!empty($id))
            {
                $sql = "SELECT * FROM  `CY_job` WHERE  id = $id";
                $row = $pdo->getRow($sql);
                $title = $row['title'];
                $author = $row['author'];
                $times = $row['times'];
    ...
    <?php
            ...
            {   
                ...
                foreach ($rows as $row ) 
                {
                    ...
                    $time = explode(" ",$times); 
            ?>
                <h4 align="left" ><a href = "CY_job.php?id=<?php echo $id?>"><?php echo $title ; ?></a><div style="float:right"><?php echo $time[0];?></div></h4>
