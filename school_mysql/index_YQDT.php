...
<div id="templatemo_wrapper">
    ...
    <p>你现在的位置是:<a href="index.php">首页</a> > <a href="index_YQDT.php">园区消息</a></p>
    ...
    <?php 
            ...
            if(!empty($id))
            {
                $sql = "SELECT * FROM  `index_YQDT` WHERE  id = $id";
                $row = fetchOne($sql);
                $title = $row['title'];
                $author = $row['author'];
                $times = $row['times'];
    ...
    <?php
            ...
            {   
                ...
                foreach ($rows as $row ) 
                {
                    ...
                    $time = explode(" ",$times); 
            ?>
                <h4 align="left" ><a href = "index_YQDT.php?id=<?php echo $id?>"><?php echo $title ; ?></a><div style="float:right"><?php echo $time[0];?></div></h4>
