...
<div id="main_container">
		...
		<div class="center_content">  
			...
			<?php 
                ...
                $table = $_GET['table'];
               	...
               	if($ids != NULL && $table != NULL)
               	{
	                ...
	                $res = fetchOne($sql);
            ?>
            	<form action="doAction.php?table=CY_news&act=mod&ids=<?php echo $ids ?>" method="POST" enctype="multipart/form-data">
            	...
            	<?php 
               	...
               	{
			?>
				<form action="doAction.php?table=CY_news" method="POST" enctype="multipart/form-data">
            ...
            <table width="100%" border="1" style="text-align:center">
                ...
                ?>
                    ...
                    <tr>
                        <td><a href="../CY_news.php?id=<?php echo $id ;?>" target="_blank"><?php echo $title; ?></a></td>
                        <td><?php echo $author; ?></td>
                        <td><?php echo $times; ?></td>
                        <td><a href="#" onclick="mod(<?php echo $id; ?>,'CY_news')">修改</a></td>
                        <td><a href="#" onclick="del(<?php echo $id; ?>,'CY_news')">删除</a></td>
                    </tr>
   ...
   <?php  require_once 'include/footer.php' ; ?> 
    ...
    {
        window.location.href="CY_news.php?id="+ids+"&table="+table;
    }
    </script>
