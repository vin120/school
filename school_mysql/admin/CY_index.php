		...
		<div class="center_content">  
			...
			<div  class="right_content">
					...
					<?php 
						...
						//创业工厂简介
						$sql = "select id from CY_about";
						$rows= fetchAll($sql);
						$rowCount1 = count($rows);
					
						//入驻通知
						$sql = "select id from CY_news";
						$rows = fetchAll($sql);
						$rowCount2 = count($rows);	
			
						//入驻团队经营情况
						$sql = "select id from CY_teamnews";
						$rows = fetchAll($sql);
						$rowCount3 = count($rows);

						//入驻团队招聘
						$sql = "select id from CY_job";
						$rows = fetchAll($sql);
						$rowCount4= count($rows);

					?>

					 <p>创业工厂简介：<?php echo $rowCount1; ?></p>
			         <p>入驻通知：<?php echo $rowCount2; ?></p>
			         <p>入驻团队经营情况：<?php echo $rowCount3; ?></p>		         	
					 <p>入驻团队招聘：<?php echo $rowCount4; ?></p>
