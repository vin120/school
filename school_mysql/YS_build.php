...
<div id="templatemo_wrapper">
    ...
    <p>你现在的位置是:<a href="index.php">首页</a> > <a href="YS_build.php">建设进展</a></p>
    ...
    <?php 
            ...
            if(!empty($id))
            {
                $sql = "SELECT * FROM  `YS_build` WHERE  id = $id";
                $row = fetchOne($sql);
                $title = $row['title'];
                $author = $row['author'];
                $times = $row['times'];
    ...
    <?php
            ...
            {   
                ...
                foreach ($rows as $row ) 
                {
                    ...
                    $time = explode(" ",$times); 
            ?>
                <h4 align="left" ><a href = "YS_build.php?id=<?php echo $id?>"><?php echo $title ; ?></a><div style="float:right"><?php echo $time[0];?></div></h4>
